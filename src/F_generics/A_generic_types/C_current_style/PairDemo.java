...
class PairDemo {
    void main() {
        ...
        // No cast needed now, since the compiler knows that,
        // for this Pair, getFirst returns a String.
        String firstString = stringPair.getFirst();

        // Integer is the type argument here. For this Pair
        // object, T means Integer.
        ...
        integerPair.setFirst(34); // autoboxing

        // This won't compile, as a primitive type cannot be
        // used as a type argument:
        // Pair<int> intPair = new Pair<>(56, 78);

        // A Pair<C> can contain objects of all classes that
        // inherit from C.
        // For example, a Pair<Number> can contain objects of
        // all classes that inherit from Number: Integer,
        ...
        // The following is an example of using a generic class
        // as a "raw type." Although it is legal, it is a bad
        // idea, since we lose the type safety normally provided
        // by generics.
