...
public class ArrayList264<E> implements List264<E> {
    private E[] elements;
    private int size = 0;
    ...
    public ArrayList264(int initialCapacity) {
    ...
    public Iterator<E> iterator() {
        return new ArrayList264Iterator();
    }

    private class ArrayList264Iterator implements Iterator<E> {
        private int index = 0;
        ...
        // we aren't going to implement the remove() method here;
