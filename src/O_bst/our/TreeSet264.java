...
public class TreeSet264<E> implements NavigableSet264<E> {
    ...
    public TreeSet264(Comparator<E> comparator) {
...
//        return false;
    ...
    private boolean containsHelper(Node<E> root, Object o) {
        if (root == null) {
            return false;
        } else {
            int comparisonResult = comparator.compare((E) o, root.data);
            ...
            if (comparisonResult == 0) {
                ...
                return containsHelper(root.right, o);
            }
        }
    }
