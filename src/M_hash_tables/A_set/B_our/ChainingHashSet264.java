package M_hash_tables.A_set.B_our;
...
public class ChainingHashSet264<E> implements Set264<E> {
    ...
    public ChainingHashSet264() {
        this(DEFAULT_INITIAL_CAPACITY, DEFAULT_MAX_LOAD_FACTOR);
    }

    @SuppressWarnings("unchecked")
    public ChainingHashSet264(int initialCapacity, double maxLoadFactor) {
        if (maxLoadFactor <= 0) {
